...
public class WardogController : MonoBehaviour
{
  ...
  void Awake()
  {
    ...
    wardogHealthPoint = GetComponent<WardogHealthPoint>();
  } // Awake
  ...
  void Update()
  {
    ...
    if (playerHP > 0f)
    {
      ...
      {
        ActivateWardogStatus();
        wardogHealthPoint.isWardogHealthPointActive = true;
  ...
  void ActivateWardogStatus()
  {
    wardogStatus.SetActive(true);
  } // Activate the wardog status
} // Class